    ...
    return (
        <div>
            <div className='about-wd'>
                I'm an ambitous Full Stack Developer who is drawn to the tech industry for its continuous challenges, growth opportunities and the blending of design and innovation. I approach my work with a wholistic lens to bring together creative solutions with functionality to diagnose, restore and ultimately generate products that are useful for both clients and users. that I draw a lot of creative energy and inspiration from my personal life.                
            </div>
